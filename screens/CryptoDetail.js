                ...
                <View style={{
                    ...
                    {/* {numberOfCharts.map((item, index) => {
                        const opacity = dotPosition.interpolate({
                            ...
                            outputRanget: [0.3, 1, 0.3],
                            extrapolate: 'clamp'
                        })

                        const dotSize = dotPosition.interpolate({
                            inputRange: [index -1, index, index + 1],
                            outputRanget: [SIZES.base * 0.8, 10, SIZES.base * 0.8],
                            extrapolate: 'clamp'
                        })

                        const dotColor = dotPosition.interpolate({
                            inputRange: [index -1, index, index + 1],
                            outputRanget: [COLORS.gray, COLORS.primary, COLORS.gray],
                            extrapolate: 'clamp'
                        })
                        ...
                        chartOptions.map((option) => {
                            return (
                                <TextButton
                                    ...
                                    customLabelStyle={{
                                        color: selectedOptions.id === option.id
